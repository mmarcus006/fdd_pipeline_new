...
def test_section_detection_with_layout():
    ...
    assert len(found_sections) > 0, f"Expected to find sections 1, 5, or 21, but found: {section_items}"
    ...
    with patch('tasks.document_processing.get_settings') as mock_settings:
        ...
        try:
            ...
            try:
                ...
                print("✓ MinerU client correctly failed as expected (MinerU not installed)")
