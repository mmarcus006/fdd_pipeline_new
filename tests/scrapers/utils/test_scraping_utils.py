...
class TestScrapingUtils:
    ...
    def test_parse_date_formats(self):
        ...
        assert parse_date_formats("13/45/2023") is None  # Invalid month/day
    ...
    def test_normalize_url(self):
        ...
        assert normalize_url("https://test.com/file.pdf", base) == "https://test.com/file.pdf"
        assert normalize_url("http://test.com/file.pdf", base) == "http://test.com/file.pdf"
        
        # Test relative URLs
        assert normalize_url("/download/file.pdf", base) == "https://example.com/download/file.pdf"
        ...
        assert normalize_url("//cdn.example.com/file.pdf", base) == "https://cdn.example.com/file.pdf"
