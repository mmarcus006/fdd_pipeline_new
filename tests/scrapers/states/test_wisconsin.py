...
class TestWisconsinScraper:
    ...
    async def scraper(self):
        ...
        scraper = WisconsinScraper(headless=True, timeout=30000)
    ...
    async def test_search_specific_franchise_valvoline(self, scraper):
        ...
        if doc_metadata:
            ...
            assert doc_metadata.additional_metadata.get("discovery_method") == "active_filings_table"
        ...
        if documents:
            ...
            if enhanced_metadata:
                ...
                if enhanced_metadata.filing_date:
                    assert "/" in enhanced_metadata.filing_date or "-" in enhanced_metadata.filing_date
                ...
                print(f"  Legal name: {enhanced_metadata.additional_metadata.get('legal_name')}")
            else:
    ...
    async def test_error_handling_invalid_franchise(self, scraper):
        ...
        doc_metadata = await scraper._search_franchise_basic("XYZNONEXISTENTFRANCHISE12345")
