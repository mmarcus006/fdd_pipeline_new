...
class TestEnhancedFDDSectionDetector:
    ...
    def detector(self):
        ...
        return EnhancedFDDSectionDetector(confidence_threshold=0.7, min_fuzzy_score=80)
                    ...
                    "para_blocks": [
                        {
                            ...
                            "lines": [
                                {"spans": [{"type": "text", "content": "Item 5"}]}
                            ],
                        }
                    ],
                },
    ...
    def test_extract_text_from_block(self, detector):
        ...
        block = {
            "lines": [{"spans": [{"content": "Item 5"}, {"content": "Initial Fees"}]}]
        }
    ...
    def test_extract_text_from_nested_blocks(self, detector):
        ...
        block = {
            "blocks": [
                {
                    "lines": [
                        {"spans": [{"content": "Item 7"}, {"content": "Investment"}]}
                    ]
                }
            ]
        }
    ...
    def test_full_detection_valvoline_example(self, detector, valvoline_json_path):
        ...
        sections = detector.detect_sections_from_mineru_json(
            str(valvoline_json_path), total_pages=75
        )
        ...
        assert (
            "Financial Performance" in item_19.item_name
            or "Performance" in item_19.item_name
        )
    ...
    def test_validation_rules(self, detector):
        ...
        validated = detector._validate_and_resolve_candidates(
            candidates, total_pages=50
        )
