...
from models import (
    # Core models
    Franchisor, FranchisorCreate, FranchisorUpdate, Address,
    FDD, FDDCreate, DocumentType, ProcessingStatus,
    FDDSection, ExtractionStatus,
    
    # Structured data models
    InitialFee, DueAt,
    OtherFee, FeeFrequency, CalculationBasis,
    InitialInvestment, InitialInvestmentSummary,
    FPR, DisclosureType,
    OutletSummary, OutletType, StateCount, validate_state_total, calculate_outlet_growth_rate,
    Financials, AuditOpinion,
    
    # Operational models
    ScrapeMetadata, PipelineLog, LogLevel,
    
    # Generic JSON storage
    ItemJSON, Item1Schema, Item2Schema, Item3Schema,
    
    # Composite models
    FDDExtractionProgress, FranchisorFDDSummary,
    
    # Utilities
    cents_to_dollars, dollars_to_cents, ValidationConfig
)
...
class TestValidateStateTotal:
    ...
    def test_validate_state_total_valid(self):
        ...
        state_counts = [
            StateCount(section_id=section_id, state_code="CA", franchised_count=50, company_owned_count=10),
            StateCount(section_id=section_id, state_code="TX", franchised_count=30, company_owned_count=5)
        ]
