...
class TestDocumentSegmentationSystem:
    ...
    def mock_dependencies(self):
        ...
        with patch('tasks.document_segmentation.get_database_manager') as mock_db_func, \
    ...
    def test_segment_document_success(self, mock_dependencies, sample_pdf_path, sample_section_boundaries):
        ...
        with patch.object(system.pdf_splitter, 'split_pdf_by_pages') as mock_split:
            ...
            with patch.object(system.pdf_splitter, 'validate_pdf_content') as mock_validate:
                ...
                with patch.object(system.metadata_manager, 'create_section_record') as mock_create:
                    mock_section = Mock()
    ...
    def test_segment_document_partial_failure(self, mock_dependencies, sample_pdf_path, sample_section_boundaries):
        ...
        with patch.object(system.pdf_splitter, 'split_pdf_by_pages', side_effect=mock_split_side_effect):
            with patch.object(system.pdf_splitter, 'validate_pdf_content') as mock_validate:
                mock_validate.return_value = SectionValidationResult(
                    is_valid=True,
                    page_count=3,
    ...
    def test_get_segmentation_status(self, mock_dependencies):
        ...
        with patch.object(system.metadata_manager, 'get_sections_by_fdd_id', return_value=mock_sections):
...
class TestPrefectTasks:
    ...
    def mock_segmentation_system(self):
        ...
        with patch('tasks.document_segmentation.DocumentSegmentationSystem') as mock_class:
            mock_system = Mock()
