...
%%EOF"""
    ...
    def create_document_metadata(
        franchise_name: str = "Test Franchise",
        state_code: str = "MN",
        **kwargs
    ) -> DocumentMetadata:
        ...
        return DocumentMetadata(
            ...
            filing_number=kwargs.get("filing_number", f"{state_code}-{datetime.now().year}-001"),
            source_url=kwargs.get("source_url", f"https://test.{state_code.lower()}.gov/doc/test"),
            download_url=kwargs.get("download_url", f"https://test.{state_code.lower()}.gov/download/test.pdf"),
    ...
    def create_franchisor(
        ...
        **kwargs
        ...
        return Franchisor(
            ...
            headquarters_address=kwargs.get("headquarters_address", {
                "street": "123 Test St",
                "city": "Test City",
                "state": state,
                "zip": "12345"
    ...
    def create_fdd(
        ...
        **kwargs
        ...
        return FDD(
            ...
            filing_number=kwargs.get("filing_number", f"{filing_state}-{datetime.now().year}-001"),
            document_type=kwargs.get("document_type", "FDD"),
    ...
    def create_scrape_metadata(
        ...
        **kwargs
        ...
        return ScrapeMetadata(
            ...
            source_url=kwargs.get("source_url", f"https://test.{source_name.lower()}.gov/doc/test"),
            filing_metadata=kwargs.get("filing_metadata", {
...
class StateSpecificFixtures:
    ...
    def minnesota_documents(count: int = 2) -> List[DocumentMetadata]:
        ...
        for i in range(count):
            docs.append(DocumentFixtures.create_document_metadata(
