...
class ExtractionMonitor:
    ...
    def get_session_summary(self) -> Dict[str, Any]:
        ...
        successful = sum(1 for m in self.current_session_metrics if m.status == "success")
        ...
        avg_duration = total_duration / total_extractions if total_extractions > 0 else 0
    ...
    def log_session_summary(self):
        ...
        summary_file = self.log_dir / f"extraction_summary_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
        try:
