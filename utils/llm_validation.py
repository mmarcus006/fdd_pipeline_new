...
class FDDValidators:
    ...
    def validate_percentage(
        value: float, field_name: str = "Percentage"
    ) -> Optional[str]:
    ...
    async def validate_business_description(
        description: str, franchise_name: str, client: Optional[InstructorClient] = None
    ) -> ValidationResult:
    ...
    async def validate_fee_description(
        fee_description: str, fee_amount: int, client: Optional[InstructorClient] = None
    ) -> ValidationResult:
...
class CrossFieldValidator:
    ...
    async def validate_year_over_year_growth(
        outlet_data: List[Dict[str, Any]], client: Optional[InstructorClient] = None
    ) -> ValidationResult:
...
def validate_output(
    validation_criteria: str, client: Optional[InstructorClient] = None
):
